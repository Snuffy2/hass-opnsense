...
async def async_setup_entry(
    ...
    # data = config_entry.runtime_data  # hass.data[DOMAIN][config_entry.entry_id]
    ...
    )  # data[DEVICE_TRACKER_COORDINATOR]
    ...
    if set(mac_addresses) != set(previous_mac_addresses):
        setattr(config_entry.runtime_data, SHOULD_RELOAD, False)  # data[SHOULD_RELOAD] = False
