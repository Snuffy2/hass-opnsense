...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    platforms: list[Platform] = getattr(
        entry.runtime_data, LOADED_PLATFORMS
    )  # hass.data[DOMAIN][entry.entry_id][LOADED_PLATFORMS]
    client: OPNsenseClient = getattr(
        entry.runtime_data, OPNSENSE_CLIENT
    )  # hass.data[DOMAIN][entry.entry_id][OPNSENSE_CLIENT]
